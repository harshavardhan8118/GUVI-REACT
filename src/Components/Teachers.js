...
const Teachers = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                let users = await axios.get("https://64205ac982bea25f6dff6b98.mockapi.io/teacher")
    ...
    const deleteUser = (id) => {
        ...
        swal({
            ...
            if (willDelete) {
                axios.delete(`https://64205ac982bea25f6dff6b98.mockapi.io/teacher/${id}`)
                    .then(() => {
                        getData();
                    });
    ...
    const getData = () => {
        axios
            .get(`https://64205ac982bea25f6dff6b98.mockapi.io/teacher`)
            .then((getData) => {
